...
export function proxy(request: NextRequest) {
  if (request.nextUrl.pathname.startsWith("/studio/leads") || request.nextUrl.pathname.startsWith("/api/leads/discover") || request.nextUrl.pathname.startsWith("/api/leads/geocode") || request.nextUrl.pathname.startsWith("/api/leads/nearby") || request.nextUrl.pathname.startsWith("/api/leads/audit")) {
