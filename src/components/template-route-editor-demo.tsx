...
export function TemplateRouteEditorDemo({
  ...
  const copy = {
    nl: {
      ...
      domainHint: "Dit is een echte check bij de registry. Je ziet meteen of de naam vrij is en wat hij per jaar kost. Vastleggen gebeurt pas als je pakket rond is.",
    ...
    en: {
      ...
      domainHint: "This is a real check against the registry. You see straight away whether the name is free and what it costs per year. Registration happens once your package is settled.",
